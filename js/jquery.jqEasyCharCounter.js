 ...
 *
 * MODIFIED BY B. MARTINOVIC, 2011-04-11
 *
 * + new option "truncate"; set to true if you wish to auto-truncate
 *   text that exceeds maxChars; default false
 * + new option "msgText"; you may change the text before the counter;
 *   default: 'Characters: '
 *
 */
(function($) {
